 ...
 // This effect will run every time `login` changes
  ...
  Welcome <span style={{ color: 'grey' }}>{loginObject}</span> to the Admin Dashboard
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <AppWidgetSummary title="Total Customers" total={1239} color="primary" icon={'mdi:account'} />
          </Grid>

          <Grid item xs={12} sm={6} md={4
          }>
            <AppWidgetSummary title="New Customers"  total={350} color="primary" icon={'mdi:account-arrow-up'} />
          </Grid>
