...
import { superadminloginRequest } from '../../../../redux/action';
...
export default function LoginForm() {
 ...
 const  loginObject = useSelector(state => state.superadmin.superadmin);
...
const handleSubmit1 = async (event) => {
  ...
  try {
    await dispach(superadminloginRequest(values.phone, values.password)); // Pass phone and password separately
