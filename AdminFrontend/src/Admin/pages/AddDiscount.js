...
try {
  // Format the start and end dates before sending to the backend
  ...
  const response = await axios.post('http://api.dopes.online/api/adddiscount', dataToSend);
  // const response = await axios.post('http://localhost:5000/api/adddiscount', dataToSend);
